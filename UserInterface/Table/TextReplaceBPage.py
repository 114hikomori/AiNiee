...
class TextReplaceBPage(QFrame, ConfigMixin, LogMixin, ToastMixin, Base):
    ...
    def update_table(self) -> None:
        ...
        self._update_table_rows(config["post_translation_data"])
    ...
    def save_data(self) -> None:
        config = self.load_config()
        config["post_translation_data"] = self._load_table_rows()
        self.save_config(config)
    ...
    def reset_data(self) -> None:
        ...
        self.save_config(config)
        self._update_table_rows(config.get("post_translation_data"))
        self.table.resizeRowsToContents()
